...
const skillsData = [
  ...
  { name: "E-Commerce", level: 75, category: "Business" },
  ...
  { name: "Flask-SocketIO", level: 82, category: "Backend" },
  ...
  { name: "Hugging Face Transformers", level: 70, category: "Machine Learning" },
  { name: "Illustrator", level: 75, category: "Creative" },
  { name: "Java", level: 72, category: "Languages" },
  { name: "JavaScript", level: 95, category: "Languages" },
  { name: "Jest", level: 80, category: "Tools" },
  { name: "Mocha", level: 78, category: "Tools" },
  { name: "Pytest", level: 80, category: "Tools" },
  { name: "Unit Testing", level: 82, category: "Tools" },
  { name: "Jupyter", level: 70, category: "Machine Learning" },
  { name: "Keras", level: 72, category: "Machine Learning" },
  { name: "Keras Sequential API", level: 70, category: "Machine Learning" },
  { name: "Kubernetes", level: 60, category: "DevOps" },
  { name: "LightGBM", level: 60, category: "Machine Learning" },
  { name: "Linux", level: 82, category: "DevOps" },
  { name: "Machine Learning With Python", level: 82, category: "Machine Learning" },
  { name: "Market Research", level: 70, category: "Business" },
  { name: "Material UI", level: 85, category: "Frontend" },
  { name: "Matplotlib", level: 70, category: "Machine Learning" },
  { name: "MLflow", level: 68, category: "Machine Learning" },
  { name: "Model Deployment", level: 72, category: "Machine Learning" },
  { name: "Model Prediction Pipelines", level: 72, category: "Machine Learning" },
  ...
  { name: "OpenCV", level: 75, category: "Machine Learning" },
  ...
  { name: "SQLAlchemy", level: 88, category: "Backend" },
  ...
  { name: "Qiskit", level: 72, category: "Machine Learning" },
  ...
  { name: "Scikit-learn Metrics", level: 72, category: "Machine Learning" },
  { name: "Seaborn", level: 68, category: "Machine Learning" },
  ...
  { name: "XGBoost", level: 65, category: "Machine Learning" },
